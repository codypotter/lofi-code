...
func Home() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<section id=\"intro\" class=\"hero is-primary is-medium\"><div class=\"hero-body is-flex is-flex-direction-column\"><img src=\"assets/images/logo-white.svg\"><p class=\"subtitle has-text-white\">learn to code in byte-size pieces</p></div></section><section class=\"section\"><div class=\"container\"><h3 class=\"title is-3 mb-5\">Browse by Tag</h3><div class=\"p-3\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "</div></div></section><section class=\"section\"><div class=\"container\"><h3 class=\"title is-3 mb-5\">Recent Posts</h3><div class=\"columns is-multiline is-flex\" style=\"align-items: stretch;\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, post := range getFeaturedPosts() {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<div class=\"column is-one-third\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "</div></div></section><section id=\"featured-video\" class=\"section is-medium\"><div class=\"container\"><h3 class=\"title is-3\">Featured Video</h3><h4 class=\"subtitle is-4 mb-5\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/home.templ`, Line: 81, Col: 63}
		}
